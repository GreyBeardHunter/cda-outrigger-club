...
export const FormlineCanoeMark = ({ className = "" }: { className?: string }) => (
  <svg viewBox="0 0 520 320" aria-hidden="true" className={className}>
    <g fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round">
      {/* mountain / ridge */}
      <path d="M40 150 L120 66 L168 110 L232 40 L300 118 L352 82 L480 150" strokeWidth="3" opacity="0.55" />
      {/* pines */}
      <path d="M96 150 L96 118 M96 118 L82 132 M96 118 L110 132 M96 130 L84 142 M96 130 L108 142" strokeWidth="2" opacity="0.6" />
      <path d="M404 150 L404 112 M404 112 L388 128 M404 112 L420 128 M404 126 L390 140 M404 126 L418 140" strokeWidth="2" opacity="0.6" />
      {/* sun / ovoid */}
      <path d="M260 40 C292 40, 308 58, 308 76 C308 96, 288 110, 260 110 C232 110, 212 96, 212 76 C212 58, 228 40, 260 40 Z" strokeWidth="4" />
      <path d="M260 58 C280 58, 290 66, 290 76 C290 88, 278 94, 260 94 C242 94, 230 88, 230 76 C230 66, 240 58, 260 58 Z" strokeWidth="1.5" opacity="0.5" />
      {/* hull */}
      <path d="M60 214 C 160 250, 360 250, 462 214 C 400 236, 120 236, 60 214 Z" strokeWidth="5" />
      {/* iako (booms) + ama (float) */}
      <path d="M170 226 C 150 250, 130 258, 108 262 M300 226 C 282 250, 262 258, 240 262" strokeWidth="3" />
      <path d="M86 266 C 150 280, 210 280, 262 266 C 210 274, 150 274, 86 266 Z" strokeWidth="3" />
      {/* paddlers as U-forms */}
      <path d="M150 214 C150 196, 168 196, 168 214" strokeWidth="4" />
      <path d="M212 212 C212 192, 232 192, 232 212" strokeWidth="4" />
      <path d="M276 212 C276 192, 296 192, 296 212" strokeWidth="4" />
      <path d="M338 214 C338 196, 356 196, 356 214" strokeWidth="4" />
      {/* paddles as S-forms */}
      <path d="M158 200 L132 232 M222 198 L196 230 M286 198 L312 230 M348 200 L374 232" strokeWidth="2.5" opacity="0.8" />
      {/* wake lines */}
      <path d="M40 292 C 140 306, 380 306, 480 292" strokeWidth="2" opacity="0.5" />
