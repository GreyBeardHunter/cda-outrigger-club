  ...
  return (
    <svg viewBox="0 0 740 420" aria-hidden="true" className={className}>
      <g fill="currentColor">
        ...
        <path d="M386 162 C 442 162, 470 186, 470 226 C 470 268, 440 292, 386 292 C 336 292, 310 268, 310 226 C 310 186, 338 162, 386 162 Z" fill={red} />
        {/* white ovoid inside the red field */}
        <path d="M392 186 C 430 186, 448 202, 448 226 C 448 252, 428 268, 392 268 C 358 268, 340 252, 340 226 C 340 202, 358 186, 392 186 Z" fill={card} />
        {/* red inner ovoid, closing the nest */}
        <path d="M390 202 C 418 202, 432 212, 432 227 C 432 244, 416 253, 390 253 C 366 253, 352 244, 352 227 C 352 212, 366 202, 390 202 Z" fill={red} />
        <path d="M386 214 C 402 214, 411 219, 411 227 C 411 236, 401 241, 386 241 C 373 241, 364 236, 364 227 C 364 219, 373 214, 386 214 Z" fill={card} />
